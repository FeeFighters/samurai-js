# Samurai.js Library - Version 0.1
# --------------------------------------------

# Require each of the modules, using Sprockets
#= require 'api/0.1/samurai/base'
#= require 'api/0.1/jquery-1.7.samurai.min.js'
#= require 'api/0.1/jquery.formparams.samurai.min.js'
#= require 'api/0.1/easyXDM-2.4.15.118/json2.js'
#= require 'api/0.1/easyXDM-2.4.15.118/easyXDM.min.js'
